...
//        check the background of top 2 sections
        System.out.println(driver.findElement(By.className("w3-pale-red")).getCssValue("background-color"));
        System.out.println(driver.findElement(By.className("w3-pale-yellow")).getCssValue("background-color"));
//        rgba(255, 221, 221, 1);
