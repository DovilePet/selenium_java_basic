...
import selenium.pages.ColorLoadingPage;
...
public class Sample9Task {
    WebDriver driver;
    static ColorLoadingPage loadingColor;
    ...
    public void loadGreenSleep() throws Exception {
        loadingColor = PageFactory.initElements(driver, ColorLoadingPage.class);
//         TODO:
//         * 1) click on start loading green button
        loadingColor.clickStartGreen();
        //driver.findElement(By.id("start_green")).click();
//         * 2) check that button does not appear,
        assertFalse(loadingColor.startGreenDisplayed());
//         * but loading text is seen instead   "Loading green..."
        assertEquals("Loading green...", loadingColor.loadingGreenText());
        Thread.sleep(5000);
//         * 3) check that both button
        assertFalse(loadingColor.startGreenDisplayed());
//         * and loading text is not seen,
        assertFalse(loadingColor.loadingGreenDisplayed());
//         * success is seen instead "Green Loaded"
        assertTrue(loadingColor.finishGreenDisplayed());
        assertEquals("Green Loaded", loadingColor.loadedGreen());
    }
